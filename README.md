# STOP DOING PINKY GYMNASTICS!!!
Using your thumb is way more comfortable.
...
It's a bad practice to just download an .exe from some dude on the internet and run it on your computer, but if you trust me, then I've included MMB_Shift.exe and you can skip the previous instruction.
...
You don't really need caps lock unless you intend to wake up sheep on facebook.
